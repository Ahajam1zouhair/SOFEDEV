                      ...
                      <div className="column flex justify-center items-center  w-1/3">
                        <div className="match-details text-center">
                          ...
                          <div className="match-score mt-2">
                            <span className="match-score-number match-score-number--leading text-xl md:text-3xl font-semibold text-purple-600 mr-1">
                              {item.scores.home}
                            </span>
                            <span className="match-score-divider text-xl md:text-3xl font-bold text-gray-500 mr-1">
                              :
                            </span>
                            <span className="match-score-number text-xl md:text-3xl font-semibold ">
                              {item.scores.away}
                            </span>
                          </div>
